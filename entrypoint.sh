...
UUID=${UUID:-'2cbcd138-b1ed-4203-858c-3e3201dd10a5'}
VMESS_WSPATH=${VMESS_WSPATH:-'/2cbcd138-b1ed-4203-858c-3e3201dd10a5-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/2cbcd138-b1ed-4203-858c-3e3201dd10a5-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/trojan'}
SS_WSPATH=${SS_WSPATH:-'/2cbcd138-b1ed-4203-858c-3e3201dd10a5-shadowsocks'}
